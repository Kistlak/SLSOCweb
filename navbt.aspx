  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
	   ...
	   <a href="index.php">
      <img src="Resources/WisdomName.png" height='50' width='200' style='margin-left:40px;margin-top:0px;'>
	   </a>	   
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="img2.php" class="BorderRight">Image Uplaod</a></li>
        ...
        <li class="dropdown">
		 ...
		 <li class="dropdown">
          <a href="#" class="BorderRight" class="dropdown-toggle" data-toggle="dropdown">Faculties <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="#">Computing</a></li>
            <li><a href="#">Busniness</a></li>
            <li><a href="#">Enrinering</a></li>
          </ul>
        </li>
